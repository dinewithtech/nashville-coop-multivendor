...
const TinyTiles: React.FC<TilesData> = ({ image, heading, buttonText, backColor, link }) => {
  ...
  return (
    <div className={`p-4 w-[95%] mx-auto flex ${backColor} dark:bg-[#1e3a4a] justify-between items-center rounded-3xl transform hover:scale-105 cursor-pointer transition duration-300`}
      // style={
