...
const HomeMiniCard: React.FC<HomeMiniCardProps> = ({ image, heading, subText, headingColor, bgColor, darkBgColor }) => {
  ...
  return (
    <div className={`h-[400px] flex justify-center items-center ${bgColor} ${darkBgColor} flex-col rounded-3xl `}
