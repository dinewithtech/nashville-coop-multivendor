...
export const Colors = {
  light: {
    ...
    iconPink: "#f50000",
    radioColor: "#FFF",
    radioOuterColor: "#f50000",
    spinnerColor: "#f50000",
    orderComplete: "#89a207",
    orderUncomplete: "#fe0000",
    horizontalLine: "#B8B8B8",
    buttonBackground: "#f50000",
    buttonText: "black",
    buttonBackgroundPink: "#f50000",
    buttonTextPink: "#FFF",
  ...
  dark: {
    primary: "#f50000", // Slightly darker green to avoid too much brightness
